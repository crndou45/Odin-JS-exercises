const palindromes = function (word) {
    // let sanWord = word.toLowerCase().replace("!","").replace(".","");
    // let revsdWord = sanWord.split('').reverse().join('');
    
    // if(revsdWord === sanWord){   //I Tried doing this one but going to go with the solution
    //     return true;
    // }
    // return false;
